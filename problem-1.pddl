(define (problem supermarket-shopping)
  ...
  (:objects
    ...
    cell13 cell14 cell15 cell16 cell17 cell18 cell19 cell20 - aisleCell
  ...
  (:init
    ...
    ; Adjacencies
    (adjacent cell1 scale) (adjacent cell4 scale) (adjacent cell14 cs)
    (in ice-lolly shelf1) (in pizza shelf2) (in cabbage shelf3)
    (in potato shelf4) (in toothpaste shelf5) (in shampoo shelf6)
  ...
  (:goal (and
   (checkout potato) (checkout ketchup) (checkout toothpaste)
    (checkout pizza)
  ))
)